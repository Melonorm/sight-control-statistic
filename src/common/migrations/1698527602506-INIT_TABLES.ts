...
export class INITTABLES1698527602506 implements MigrationInterface {
    name = 'INITTABLES1698527602506'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "flight" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying, "speed" numeric NOT NULL, "exerciseResultId" integer NOT NULL, CONSTRAINT "UQ_ee8731ef74100611afe6999a6d9" UNIQUE ("uuid"), CONSTRAINT "PK_bf571ce6731cf071fc51b94df03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "exercise_result" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "timestamp" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL, "shooterId" integer NOT NULL, CONSTRAINT "UQ_073f1b0dff8d6a250833c569678" UNIQUE ("uuid"), CONSTRAINT "PK_1436b75b03359a0707c29c6c604" PRIMARY KEY ("id"))`);
